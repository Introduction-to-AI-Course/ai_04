...
from marker.polite import *
from marker.thx import *
from marker.tel import *
from marker.fromwhom import *
from marker.date import *
import jieba
import pandas as pd
...
def WriteToExcel(inFile='infile/附件4.xlsx', outFile='outfile/评分后附件4.xlsx'):
    ...
    writeOneCol(score, '完整性', inFile, outFile)
